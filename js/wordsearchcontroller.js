...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Italian FOOD": [["Pizza", "Pasta", "Garlic Bread", "Panni"],
			["Antipasto", "Gelato", "Cannoli", "Pesto"],
			["Calzone", "Lasagna",]],

		"Italian DRINKS": [["Coffee", "Latte", "Cappuccino", "Americano"],
			["Espresso", "Flat White", "Mocha", "Froth",],],

		"Italian PLACES": [["Rome", "Milan", "Naples", "Pisa"],
			["Verona", "Turin", "Siena", "Sicily"],
			["Venice",]],

		"Italian STAFF": [["Michael", "Staz", "Christina", "Domenico"],
			["Harry", "Alessia", "Grace", "George"],
			["Tony", "Ethan", "Elle", "Ella"],
			["Elusia", "Chloe", "Hollie", "Shauna"],],

		"Italian CARS": [["Ferrari", "Lamborghini", "Fiat", "Bugatti"],
			["Osca", "Cizeta", "Zagato", "Lancia"]],
